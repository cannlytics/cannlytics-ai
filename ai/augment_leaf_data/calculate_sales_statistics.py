...
lab_results.rename(columns={'created_at': 'tested_at'}, inplace=True)
...
#--------------------------------------------------------------------------
# Augment the data with retailer licensee data.
# Approximate runtime:
#--------------------------------------------------------------------------
...
licensees.rename(columns={'name': 'retailer_name'}, inplace=True)
data = pd.merge(
    left=data,
    right=licensees,
    how='left',
...
print('Time to augment with licensees data:', print(end - start))
